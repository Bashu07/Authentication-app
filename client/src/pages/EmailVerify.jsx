...
const EmailVerify = () => {
  ...
  const handlePaste = (e)=>{
    ...
    const pasteArray = paste.split('').slice(0, 6); // ✅ Limit to 6 character
...
<form  onSubmit={onSubmitHandler} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
  ...
  <button className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full'>VerifyEmail</button>
